...
1. Enter this follow-up prompt:
   ...
   +++Add a section summarizing anticipated outcomes and success metrics for the event.* and select Send or enter on your keyboard.+++
...
1. Open **Word** from the taskbar to create a new document.
...
1. Under **File** at the top right corner of your document, select **Save As** to save your document.

1. Under Other Locations select **This PC** and enter a **file name** in the textbox at the top to give your document a name (ex: Client Summit Planning Brief).

1.  Select **Save** and **close** out of your document.
...
1. Select **Add a file(paper clip icon)** on the bottom right corner of the prompt box to open the File Explorer dialogue and select **Documents** on right to locate your recently saved document from **Task 4**.

1. Select your document and select **Open** at the bottom of File Explorer to upload the file to the Copilot Chat prompt box. 
...
Turn the email draft into a collaborative workspace using Copilot Pages. This will let you simulate how multiple team members can refine content in real time.

1. Select **Edit in Pages** underneath Copilot’s last response in Task 5 (or any response you prefer) to copy over that informatoin to Copilot Pages. 

1. A new Copilot Page will open on the right side of Copilot Chat, explore the following actions:

    - Give the page a new title at the top of the page.  
    - Type any additional content throughout the page.
